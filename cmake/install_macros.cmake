...
FUNCTION(INSTALL_DOCUMENTATION)
  MYSQL_PARSE_ARGUMENTS(ARG "COMPONENT;SUBDIR" "" ${ARGN})
  SET(files ${ARG_DEFAULT_ARGS})
  IF(NOT ARG_COMPONENT)
    SET(ARG_COMPONENT Server)
  ENDIF()
  IF(ARG_SUBDIR)
    SET(ARG_SUBDIR "/${ARG_SUBDIR}")
  ENDIF()
  ...
  INSTALL(FILES ${files} DESTINATION ${destination}${ARG_SUBDIR} COMPONENT ${ARG_COMPONENT})
ENDFUNCTION()
